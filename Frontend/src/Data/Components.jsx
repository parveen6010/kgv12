export const comp=[
    {heading:"WHEEL HUB MOTOR    ",
     paragraph:`A wheel hub motor is an electric motor that is integrated
     into the hub of a vehicles wheel which directly drives the
     ...
     {heading:"CONTROLLER",
     paragraph:`The controller is used to control and manage the power
     output through the motor, digital meter, and other
     accessories in hybrid electric vehicles. The controller is
     single-phase with a power range of 1-2.5KW, a voltage
     range of 36-72V with a current supply of 20-40A.`},
     {heading:"THROTTLE",
     paragraph:`This throttle is based on a Hall effect magnetic sensor for
