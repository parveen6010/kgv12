...
export const Home = () => {
  return (
    <div className=" w-screen min-w-fit overflow-hidden ">
      ...
      <div className="   sm:hero sm:flex sm:flex-col sm:h-screen sm:justify-center sm:items-center md:hero md:flex md:flex-col md:h-screen md:justify-center md:items-center lg:hero lg:flex lg:flex-col lg:h-screen lg:justify-center lg:items-center" >
      <h1 className=" min-[300px]:text-center  text-black lg:text-4xl font-extrabold absolute top-32 font-serif text-center z-10" style={{ fontFamily: 'Anybody' }}>
  Welcome to the world of smart E-MOBILITY solution{" "}
</h1>         {/* <img src={bike5} className="scale-100 absolute top-30 z-30  "/> */}
         <img
          src={bike5}
