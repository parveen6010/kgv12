...
export const Product = () => {
  return (
    <div className=" w-full overflow-x-hidden    ">
      {/* hero page */}
      {/* <div
        className=" md:h-[700px] bike-firstpage flex flex-col items-center justify-center  w-screen bg-gradient-radial from-[rgba(0,0,0,0.75)] via-gray-400 to-[rgba(0,0,0,0.75)]"
